...
-- Themes
config_dir = ("/home/justin/.config/awesome/")
...
tags = {}
for s = 1, screen.count() do
    tags[s] = awful.tag({"local", "remote", "web", "chat"}, s, layouts[1])
end
...
vicious.register(
  neticon, vicious.widgets.wifi, function(widget, args)
...
vicious.register(
  ...
  '<span background="#92B0A0" font="Inconsolata 11"><span font="Inconsolata 11" color="#FFFFFF" background="#92B0A0">$1$2% </span></span>', 
  30, "BAT1" 
)
